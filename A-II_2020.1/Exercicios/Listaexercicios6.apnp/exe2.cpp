...
void cadastraproduto(produto v[],int ic)
{
    ...
    gets(v[ic].nome);
    fflush(stdin);
    cout << "Informe quantas unidades do produto: ";
    cin >> v[ic].unidade;
...
void venderproduto(produto v[],int ic,int c,int qtv){
    ...
    for(int i = 0;i <= ic;i++){
        if(v[i].codigo == c && v[i].quantidade > qtv){
            ...
            cout << "Nome do Produto: " << v[i].nome << endl;
            cout << "Unidade do Produto: " << v[i].unidade << endl;
            cout << "Valor depois da venda do Produto: " << v[i].valorvenda << endl;
            cout << "Quantidade do Produto: " << v[i].quantidade << endl;
            cout << "---------------------------------" << endl;
            getchar();
        }else{
...
//obs: não entendi se unidade refere-se ao quantitativo de produtos em um lote ou a unidade de medida
